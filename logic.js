...
var _getBestRouteString = Module['_getBestRouteString'] = makeInvalidEarlyAccess('_getBestRouteString');
var _getBestDistance = Module['_getBestDistance'] = makeInvalidEarlyAccess('_getBestDistance');
var _updateSingleTraffic = Module['_updateSingleTraffic'] = makeInvalidEarlyAccess('_updateSingleTraffic');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['getBestRouteString'] != 'undefined', 'missing Wasm export: getBestRouteString');
  assert(typeof wasmExports['getBestDistance'] != 'undefined', 'missing Wasm export: getBestDistance');
  assert(typeof wasmExports['updateSingleTraffic'] != 'undefined', 'missing Wasm export: updateSingleTraffic');
  ...
  _getBestRouteString = Module['_getBestRouteString'] = createExportWrapper('getBestRouteString', 0);
  _getBestDistance = Module['_getBestDistance'] = createExportWrapper('getBestDistance', 0);
  _updateSingleTraffic = Module['_updateSingleTraffic'] = createExportWrapper('updateSingleTraffic', 3);
